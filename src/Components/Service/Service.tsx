              ...
              <section id="services" className="services">
                <div className="container">
                  <div className="section-title">
                    ...
                    <h2 style={{ color: "#D2691E" }}>Titre</h2>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <img src="e.jpeg" className="rounded object-cover" height={200} width="100%" alt="" />
                      </div>
                      <div className="col-md-6">
                        <img src="z.jpeg" className="rounded object-cover" height={200} alt="" width="100%" />
                      </div>
                    </div>
                    <h2 className="mt-3" style={{ color: "#D2691E" }}>Titre</h2>
                    <p className="text-justify">
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <img src="r.jpeg" height={200} className="rounded object-cover" width="100%" alt="" />
                      </div>
                      <div className="col-md-6">
                        <img src="t.jpeg" height={200} className="rounded object-cover" alt="" width="100%" />
                      </div>
                    </div>
                    <h2 className="mt-3" style={{ color: "#D2691E" }}>Titre</h2>
                    <p className="text-justify">
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <img src="u.jpeg" height={200} className="rounded" width="100%" alt="" />
                      </div>
                      <div className="col-md-6">
                        <img src="y.jpeg" height={200} className="rounded" alt="" width="100%" />
                      </div>
                    </div>
                </div>
              </section>
            ...
            <p className="m-5">
              <section id="services" className="services">
                <div className="container">
                  ...
                  <p className="text-justify">Un plafond en Gyproc® offre une foule d'avantages. Nos systèmes de plafonds permettent en effet de camoufler facilement tuyaux, câbles et autres éléments techniques, mais certains contribuent en outre à optimiser l'isolation thermique, ainsi que l'isolation ou l'absorption acoustique</p>
                  <img src="i.jpeg" className="rounded" width="100%" height={300} alt="" />
                </div>
              </section>
            </p>
          </div>
